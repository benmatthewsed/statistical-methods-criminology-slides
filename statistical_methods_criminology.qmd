...
![](https://c2.thirdlight.com/file/8/Tb2SsM4TXyBWQHTblABTsjunye/primary-logo.png){width=70% fig-alt="University of Stirling logo"}

![](https://www.ncrm.ac.uk/site-resources/images/webpage-meta-image.jpg){width=90% fig-alt="National Centre for Research Methods logo"}

## Welcome!

- Who we are
- [Who you are](https://www.menti.com/aloosdgvnebw)
...
- Materials will [live online here](https://benmatthewsed.github.io/statistical-methods-criminology-slides/statistical_methods_criminology.html#/title-slide) so you can access them any time
...
- 10:00 – Welcome
- 10:15 – [Data provenance: Types of criminological data](https://benmatthewsed.github.io/statistical-methods-criminology-slides/statistical_methods_criminology.html#/session-one-types-of-criminological-data)
- 11:15 – Break
- 11:30 – [Modelling: Telling stories with the general linear model](https://benmatthewsed.github.io/statistical-methods-criminology-slides/statistical_methods_criminology.html#/the-general-linear-model)
- 12:30 – Lunch
- 13:30 – Q&A
- 13:40 – [Sensitivity analysis and critiquing results: Measurement error, selection and - confounding in crime data](https://benmatthewsed.github.io/statistical-methods-criminology-slides/statistical_methods_criminology.html#/measurement-error-selection-and-confounding)
- 14:40 – Break
- 14:55 – [Simulation methods and translating results: Making model coefficients meaningful with simulation](https://benmatthewsed.github.io/statistical-methods-criminology-slides/statistical_methods_criminology.html#/turning-coefficients-into-meaningful-quantities-of-interest)
- 15:55 – Short break
- 16:05 – [Discussing results and ethics](https://benmatthewsed.github.io/statistical-methods-criminology-slides/statistical_methods_criminology.html#/ethics-and-commuicating-statistical-results)
- 16:45 – Recap and Q&A
- 17:00 – Depart
...
- You can find the course materials at [https://github.com/benmatthewsed/statistical-methods-criminology-slides/](https://github.com/benmatthewsed/statistical-methods-criminology-slides/)
- If you don't have an `R` installation, you can follow along in your browser via [posit.cloud](posit.cloud) (free account required) [Ben post the link in the chat now]
- Or you can use the completed of the results rather than run them yourself (there will be links for each practical)
...
## Course statisticalness

![](resources/course-statisticalness.jpg)
...
![How a crime is recorded flowchart](resources/sg-recorded-crime-01.png){fig-alt="Flowchart showing the police record crime. From Scottish Government (2016)"}
...
![How a crime is recorded flowchart](resources/sg-recorded-crime-02.png){fig-alt="Flowchart showing the police record crime. From Scottish Government (2016)"}
...
![How a crime is recorded flowchart](resources/sg-recorded-crime-03.png){fig-alt="Flowchart showing the police record crime. From Scottish Government (2016)"}
...
![How a crime is recorded flowchart](resources/sg-recorded-crime-04.png){fig-alt="Flowchart showing the police record crime. From Scottish Government (2016)"}
...
![How a crime is recorded flowchart](resources/sg-recorded-crime-05.png){fig-alt="Flowchart showing the police record crime. From Scottish Government (2016)"}
...
- (But at least the process is known and documented though)
...
- What is the context for the data collection (routine activity, bespoke intervention, to meet a target)?
    - It Depends? National statistics are routine collections, [there are other data though that might be more bespoke](https://www.law.ed.ac.uk/sites/default/files/2022-08/FPN%204th%20report%20-%20FINAL.pdf)
...
- What are the relevant definitions and concepts that govern the data/data collection?"
  - The current [Scottish Crime Recording Standard](https://www.gov.scot/publications/scottish-crime-recording-standard-crime-recording-counting-rules-2/) is 550 pages long (!). I have not read it[^10].
    - Of course, these [aren't the same crime recording rules as in England and Wales...](https://reshare.ukdataservice.ac.uk/852854/)

[^10:] In the words of a colleague "I have read sections of the Scottish Crime Recording Standard and it is a DREAM, if your dream is extensively documented micro considerations of scenarios that often seem the same BUT AREN’T."
...
- First, a statistically significant result can wrongly lead people to assume that their results are generalizable
...
- Second, it can lead people to undervalue actual observed differences in their data
...
- Surveys are very rarely random samples; most come with [weights](https://notstatschat.rbind.io/2020/08/04/weights-in-statistics/)
- These weights "describe how the sample can be scaled up to the population" [@lumleyWeightsStatistics2020]
- You should use these when calculating your descriptives
...
![Stengths of recorded crime and victimization surveys](resources/sg-strengths-limitations-01.png){fig-alt="Part One of a table comparing recorded crime and the Scottish Crime and Justice Survey. From Scottish Government (2016)"}
Source: [@justiceanalyticalservicesUserGuideRecorded2016, p57]

## Comparing police recorded crime and victimization survey data

![Stengths of recorded crime and victimization surveys](resources/sg-strengths-limitations-02.png){fig-alt="Part Two of a table comparing recorded crime and the Scottish Crime and Justice Survey. From Scottish Government (2016)"}
...
- We'll meet back at [time] to discuss
...
- You often see these written in mathematical notation like this...
...
R script: [practical-02.R](https://github.com/benmatthewsed/statistical-methods-criminology-slides/blob/master/practical_02.R)
R answers: [practical-02-answers.md](https://github.com/benmatthewsed/statistical-methods-criminology-slides/blob/master/practical-02-answers.md)
...
## Things we talked about in the morning session

- [Jon Bannister and team's data science work](https://e-space.mmu.ac.uk/624291/1/2-5_Insights-from-Data-Science_Vulnerability.pdf)
- [Jess Phoenix's Phd thesis](https://www.research.lancs.ac.uk/portal/en/publications/measuring-the-repetition-of-domestic-violence-and-abuse-in-police-data(7ba6ea8f-cf0f-4024-908a-287de3125c70).html)
- [Introduction to R](https://r4ds.hadley.nz/)

# Q&A  {background-color="#006938"}
...
![](resources/fake-data.jpg)

## Measurement error

![](resources/measurement-error.jpg)
...
![Comparison of property crime and homicide rates using data from the police, a victimisation survey (CSEW) and vital statistics (NCHS), Figure 2 in Pina-Sanchez et al. 2022](https://media.springernature.com/full/springer-static/image/art%3A10.1007%2Fs10940-022-09557-6/MediaObjects/10940_2022_9557_Fig2_HTML.png){fig-alt="Comparison of property crime and homicide rates using data from the police, a victimisation survey (CSEW) and vital statistics (NCHS)"}
...
![](resources/unmeasured-confounding.jpg)
...
- In the last session we discussed reasons to be skeptical about our model coefficients, and looked at some methods which adjust coefficients to account for possible biases in the data
...
var1 <- 
rnorm(
  n = 10000, # simulate 10000 values
  mean = 0, # with mean zero
  sd = 1 # and standard deviation 1
)

tibble(                   # these lines
  var1 = var1,            # of the resulting
) |>                      # simulated values
  ggplot(aes(x = var1)) +
  geom_histogram()
...
coef_draws |> 
  ...
  mutate(exp_coef = exp(coef)) # we calculate the exponent
...
- We calculate the Victimization Divide for each one these simulated coefficient draws
- This gives us a distribution of Victimization Dividess
...
::: {.column width="34%"}
This is what the Victimization Divide formula looks like in `R`
:::
...
## Calculating Victimization Dividess
...
## Calculating Victimization Divides
...
::: {.column width="34%"}
Calculating the Victimization Divide for these two results, based just on the odds ratios from the two models, shows that victimization inequality decreased by _52%_ between the two years. 

From the models' point estimates, we would conclude that victimization inequality between men and women fell by more than half between 2015 and 2020... but this doesn't factor in the uncertainty in the models' coefficients.
:::
...
::: {.column width="34%"}
Once we tidy the results up a bit, we can pass these simulated draws to our `victim_divide()` function to get a distribution of Victimization Divides.

From these we can calculate confidence intervals to see how sure we can be that victimization inequality between men and women fell by 52%.
:::
...
::: {.column width="34%"}
We can see the 2.5 and 97.5 percentiles of the simulated Victimization Divides, as well as the histogram of their distribution. 
...
- The beauty of this simulation approach is that it generalizes to _any DQI_ that is a function of the model's parameters, such as Victimization Divide, and to _any GLM_ [@kingMakingMostStatistical2000]
- This can help us match how we present our results to how our data was generated (in this case, by a sample survey)
- Say that instead of the Victimziation Divides were interested in the absolute difference in predicted victimization rates after controlling for other factors (like a marginal effect)
...
In this practical we'll translate coefficients into more meaningful descriptions:

R code: [practical-04.R](https://github.com/benmatthewsed/statistical-methods-criminology-slides/blob/master/practical_04.R)
Answers: [practical-04-answers.md](https://github.com/benmatthewsed/statistical-methods-criminology-slides/blob/master/practical-04-answers.md)
...
- Quantitative Bias Analysis: 
  - Maybe [_Quantitative Assessment of Systematic Bias: A Guide for Researchers_](https://journals.sagepub.com/doi/10.1177/00220345231193314) or [@kawabataQuantitativeBiasAnalysis2023]?
- Simulating meaningful quantities from results
  - [`{clarify}`(https://iqss.github.io/clarify/) and [`{marginaleffects}`](https://marginaleffects.com/) `R` packages
- Ethics
  - [Data Feminism](https://data-feminism.mitpress.mit.edu/pub/czq9dfs5/release/3)
  - [@walterIndigenousStatisticsQuantitative2013]


## Course Feedback

- Please take a few minutes to fill in the course evaluation form: [https://www.ncrm.ac.uk/surveys/edin](https://www.ncrm.ac.uk/surveys/edin)
