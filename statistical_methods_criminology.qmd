...
- Requirements to report on on crime levels mean there are incentives to reduce figures?
...
## Data provenance: victiization surveys
...
- Survey data are definitely a sample, and so surveys we almost always do want to do inferential statistics/adjust the data we see in the spreadsheet to better match the target population
...
![Stengths of recorded crime and victimization surveys](resources/sg-strenghts-limitations-01.png)
Source: [@justiceanalyticalservicesUserGuideRecorded2016, p57]

## Comparing police recorded crime and victimization survey data

![Stengths of recorded crime and victimization surveys](resources/sg-strenghts-limitations-02.png)
...
- Coefficients from GLMs may biased because:
  ...
  - our data omits some variables that we theoretically think are important [(confounding)](https://stats.stackexchange.com/a/496387), or;
  - omit some people/cases we care about [(selection effects)](https://en.wikipedia.org/wiki/Selection_bias)
...
- I like to this of this as selection bias affecting the rows of our dataset - there are some rows that are missing that we would like to see
...
- However, approaches don't scale well with more complicated models, or complicated transformations (McElreath; Gelman and Pardoe)
...
## Example one: community loss

- @simesPunishingPlacesGeography2021 gives a good example of how our theoretical framing affects how we interpret data
- Simes analysed imprisonment data from the state of Massachusets in the USA, including spatial regression of prison admission rates and how these relate to “racial demographics, social and economic disadvantage, arrest rates, and violent crime” [@simesPlacePunishmentSpatial2018a]
- A key point of Simes's analysis is that the spatial context of punishment matters - if people live in more 'punishing places', this has effects _at the community level_
- For Simes, this is key to the story of the data - that 